...
public class MultiplayerManagerTAL : MonoBehaviourPunCallbacks
{
    ...
    public override void OnRoomListUpdate(List<RoomInfo> roomList)
    {
        ...
        foreach (RoomInfo roomInfo in roomList)
        {
            if (!roomInfo.RemovedFromList)
                roomsListText.text += roomInfo.Name + string.Format(CURRENT_ROOM_PLAYERS_PATTERN,
                roomInfo.PlayerCount, roomInfo.MaxPlayers) + Environment.NewLine;
            else
            {
